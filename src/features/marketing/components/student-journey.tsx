    ...
    <div className="relative">
      ...
      <div className="grid items-stretch gap-4 md:grid-cols-2 lg:gap-5">
        {journeySteps.map((step, index) => (
          <article
            key={step.title}
            className="relative rounded-3xl border bg-card p-5 shadow-sm shadow-foreground/5 transition-colors hover:border-primary/25 motion-reduce:transition-none sm:p-6"
          >
